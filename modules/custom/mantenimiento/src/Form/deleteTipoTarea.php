 ...
 */
class deleteTipoTarea extends FormBase {

    /**
    * {@inheritdoc}
    */
    public function getFormId() {
        return 'mantenimiento_deleteTipoTarea';
    }
    ...
    */
    public function buildForm(array $form, FormStateInterface $form_state, $arg=null) {
        ...
        $miRegistro = getRegistro("tp_tipo_tarea", "id_tipo_tarea", $arg);
    ...
    */
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $miRegistro = getRegistro("tp_tipo_tarea", "id_tipo_tarea", $id);

        drupal_set_message("Se ha eliminado el tipo de tarea: ". $miRegistro['nombre'] );
