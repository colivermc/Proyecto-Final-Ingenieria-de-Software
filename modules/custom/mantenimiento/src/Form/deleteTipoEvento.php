 ...
 */
class deleteTipoEvento extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'mantenimiento_deleteTipoEvento';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $arg=null) {
    ...
    $form['elemento_imagen'] = array(
      '#markup' => '<div class="eliminar-modal">El registro a eliminar es '. $arg.'. <br><br><i>Esta acción no se podrá deshacer.</i></div>' ,
    );
  ...
  $form_state->setRedirect('mantenimiento.tiposEventos');
