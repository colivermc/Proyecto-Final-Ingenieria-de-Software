 ...
 */
class addEstadoTarea extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'mantenimiento_addEstadoTarea';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $result = $connection->insert('tp_estado_tarea')
    ->fields($campos)
    ->execute();

    drupal_set_message("Datos guardados correctamente. Se ha creado el estado de tarea \"".trim($form_state->getValue('nombre'))."\"");
