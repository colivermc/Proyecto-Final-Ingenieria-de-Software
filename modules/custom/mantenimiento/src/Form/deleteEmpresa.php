 ...
 */
class deleteEmpresa extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'mantenimiento_deleteEmpresa';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $arg=null) {
    ...
    $miRegistro = getRegistro("tp_empresa", "id_empresa", $arg);
...
//    $form['#attached']['library'][] = 'seven/global-styling';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $miRegistro = getRegistro("tp_empresa", "id_empresa", $id);
