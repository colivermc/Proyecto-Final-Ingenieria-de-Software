 ...
 */
class editEstadoTarea extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'mantenimiento_editEstadoTarea';
  }

  public function Listarunregistro($arg) {
    $connection = \Drupal::database();
    $query = $connection->query("SELECT * FROM {tp_estado_tarea} WHERE id_estado_tarea = :id_estado_tarea", [
      ':id_estado_tarea' => $arg,
    ]);
   ...
   */
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        drupal_set_message("Datos guardados correctamente. Se ha actualizado el estado de tarea ". trim($form_state->getValue('nombre')) );
